pipeline {
    ...
    stages {
        stage ('Build Image') {
            steps {
                checkout scmGit(branches: [[name: '*/dev']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-sagitta-credentials', url: 'https://github.com/5agitta/apps-tax-service.git']])
